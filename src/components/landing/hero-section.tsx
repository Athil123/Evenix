...
export function HeroSection() {
  return (
    <section id="home" className="relative h-[80vh] min-h-[600px] w-full text-white">
      ...
      />
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-6">
           <div className="w-full max-w-4xl">
             <h1 className="text-5xl md:text-7xl font-dodger font-bold tracking-wider uppercase text-shadow-lg drop-shadow-2xl">Evenix Automobile Pvt Ltd</h1>
           </div>
